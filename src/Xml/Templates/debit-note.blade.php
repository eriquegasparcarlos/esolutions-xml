...
use App\ESolutions\Xml\Support\XmlTpl;
...
<DebitNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2"
    ...
    <cbc:DebitNoteTypeCode listAgencyName="PE:SUNAT"
                           listName="Tipo de Documento"
                           listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01">08</cbc:DebitNoteTypeCode>
    ...
    {{-- Totals (DebitNote uses RequestedMonetaryTotal) --}}
    ...
    @foreach(($lines ?? []) as $line)
        ...
        <cac:DebitNoteLine>
            ...
            <cbc:DebitedQuantity unitCode="{{ $line['unitCode'] ?? '' }}"
                                 unitCodeListID="UN/ECE rec 20"
                                 unitCodeListAgencyName="United Nations Economic Commission for Europe">{{ $line['quantity'] ?? '0' }}</cbc:DebitedQuantity>
