...
class SunatCdrParser implements CdrResponseParserInterface
{
    ...
    {
        LogHelper::store($result, 'parseBill');
        ...
        if (empty($raw)) {
            ...
            LogHelper::store($res, 'parseBill-1');
            return $res;
        }
        ...
        try {
            ...
            if ($cdrBase64 && base64_decode($cdrBase64, true)) {
                ...
                LogHelper::store($res, 'parseBill-2');
                return $res;
            }
            ...
            if ($faultCode || $faultStr) {
                ...
                LogHelper::store($res, 'parseBill-3');
                return $res;
            }
            ...
            LogHelper::store($res, 'parseBill-4');
            return $res;
            ...
            LogHelper::store($res, 'parseBill-ERR');
            return $res;
        }
    }
    ...
    {
        LogHelper::store($result, 'parseSummary');
        ...
        if (empty($raw)) {
            ...
            $res['message'] = 'No se recibió respuesta válida de SUNAT.';
            $res['errors'] = ['No se recibió respuesta SOAP'];
            LogHelper::store($res, 'parseSummary-1');
            return $res;
        }
        ...
        try {
            ...
            if ($ticket) {
                ...
                $res['ticket'] = $ticket;
                LogHelper::store($res, 'parseSummary-2');
                return $res;
            }
            ...
            $res['code'] = $judge['normalized_code'];
            $res['errors'] = array_filter([$faultCode, $faultStr]);
            LogHelper::store($res, 'parseSummary-3');
            return $res;
            ...
            $res['errors']       = [$e->getMessage()];
            LogHelper::store($res, 'parseSummary-ERR');
            return $res;
        }
    }
    ...
    {
        LogHelper::store($result, 'parseGetStatus-1');
        ...
        if (empty($raw)) {
            ...
            $res['message'] = 'No se recibió respuesta válida de SUNAT.';
            $res['errors'] = ['No se recibió respuesta SOAP'];
            LogHelper::store($res, 'parseGetStatus-2');
            return $res;
        }
        ...
        try {
            ...
            if ($faultCode || $faultStr) {
                ...
                $res['code'] = $judge['normalized_code'];
                $res['errors'] = array_filter([$faultCode, $faultStr]);
                LogHelper::store($res, 'parseGetStatus-3');
                return $res;
            }
            ...
            if ($statusCode !== null) {
                ...
                if ($statusCode === '0') {
                    ...
                    if ($content && base64_decode($content, true)) {
                        ...
                        $res['cdr'] = $xmlCdr;
                        $res['notes'] = $notes ?: null;
                        LogHelper::store($res, 'parseGetStatus-4');
                        return $res;
                    }
                    ...
                    LogHelper::store($res, 'parseGetStatus-5');
                    return $res;
                }
                ...
                if ($statusCode === '98') {
                    ...
                    $res['code'] = '98';
                    LogHelper::store($res, 'parseGetStatus-6');
                    return $res;
                }
                ...
                if ($statusCode === '99') {
                    ...
                    if ($content && base64_decode($content, true)) {
                        ...
                        LogHelper::store($res,  'parseGetStatus-6.99-withCDR');
                        return $res;
                    }
                    ...
                    LogHelper::store($res,  'parseGetStatus-6.99-noCDR');
                    return $res;
                }
                ...
                $res['code'] = $judge['normalized_code'];
                $res['errors'] = $content ? [$content] : null;
                LogHelper::store($res, 'parseGetStatus-7');
                return $res;
            }
            ...
            LogHelper::store($res, 'parseGetStatus-8');
            return $res;
            ...
            $res['errors']       = [$e->getMessage()];
            LogHelper::store($res,  'parseGetStatus-9');
            return $res;
        }
    }
}
