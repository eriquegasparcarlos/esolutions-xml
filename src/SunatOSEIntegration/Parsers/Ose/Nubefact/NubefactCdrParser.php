...
namespace App\ESolutions\SunatOSEIntegration\Parsers\Ose\Nubefact;
...
use App\ESolutions\Helpers\LogHelper;
use DOMXPath;
...
class NubefactCdrParser implements CdrResponseParserInterface
{
    ...
    {
        LogHelper::store($result, 'Nubefact.parseBill.IN');
        ...
        if (empty($raw)) {
            ...
            LogHelper::store($res, 'Nubefact.parseBill.NO_RAW');
            return $res;
        }
        ...
        try {
            ...
            if ($cdrBase64 && base64_decode($cdrBase64, true)) {
                ...
                LogHelper::store($res, 'Nubefact.parseBill.OK_CDR');
                return $res;
            }
            ...
            if ($faultCode || $faultStr || $detailMsg) {
                ...
                LogHelper::store($res, 'Nubefact.parseBill.FAULT');
                return $res;
            }
            ...
            LogHelper::store($res, 'Nubefact.parseBill.ODD');
            return $res;
            ...
            LogHelper::store($res, 'Nubefact.parseBill.ERR');
            return $res;
        }
    }
    ...
    {
        LogHelper::store($result, 'Nubefact.parseSummary.IN');
        ...
        if (empty($raw)) {
            ...
            $res['message']    = 'No se recibió respuesta válida de OSE/Nubefact.';
            $res['errors']     = ['No se recibió respuesta SOAP'];
            LogHelper::store($res, 'Nubefact.parseSummary.NO_RAW');
            return $res;
        }
        ...
        try {
            ...
            if ($ticket) {
                ...
                $res['ticket']         = $ticket;
                LogHelper::store($res, 'Nubefact.parseSummary.OK_TICKET');
                return $res;
            }
            ...
            $res['code']           = $judge['normalized_code'];
            $res['errors']         = array_filter([$faultCode, $faultStr, $detailMsg]);
            LogHelper::store($res, 'Nubefact.parseSummary.FAULT');
            return $res;
            ...
            $res['errors']         = [$e->getMessage()];
            LogHelper::store($res, 'Nubefact.parseSummary.ERR');
            return $res;
        }
    }
    ...
    {
        LogHelper::store($result, 'Nubefact.parseGetStatus.IN');
        ...
        if (empty($raw)) {
            ...
            $res['errors']     = ['No se recibió respuesta SOAP'];
            LogHelper::store($res, 'Nubefact.parseGetStatus.NO_RAW');
            return $res;
        }
        ...
        try {
            ...
            if ($faultCode || $faultStr) {
                ...
                LogHelper::store($res, 'Nubefact.parseGetStatus.FAULT');
                return $res;
            }
            ...
            if ($statusCode !== null) {
                ...
                if ($statusCode === '0') {
                    if ($content && base64_decode($content, true)) {
                        ...
                        $res['cdr']            = $xmlCdr;
                        $res['notes']          = $notes ?: null;
                        LogHelper::store($res, 'Nubefact.parseGetStatus.OK_0');
                        return $res;
                    }
                    ...
                    LogHelper::store($res, 'Nubefact.parseGetStatus.0_NOCDR');
                    return $res;
                }
                ...
                if ($statusCode === '98') {
                    ...
                    $res['code']           = '98';
                    LogHelper::store($res, 'Nubefact.parseGetStatus.98');
                    return $res;
                }
                ...
                if ($statusCode === '99') {
                    if ($content && base64_decode($content, true)) {
                        ...
                        $res['cdr']            = $xmlCdr;
                        $res['notes']          = $notes ?: null;
                        LogHelper::store($res, 'Nubefact.parseGetStatus.99_WITH_CDR');
                        return $res;
                    }
                    ...
                    LogHelper::store($res, 'Nubefact.parseGetStatus.99_NO_CDR');
                    return $res;
                }
                ...
                $res['code']           = $judge['normalized_code'];
                $res['errors']         = $content ? [$content] : null;
                LogHelper::store($res, 'Nubefact.parseGetStatus.OTHER');
                return $res;
            }
            ...
            LogHelper::store($res, 'Nubefact.parseGetStatus.UNEXPECTED');
            return $res;
            ...
            $res['errors']         = [$e->getMessage()];
            LogHelper::store($res, 'Nubefact.parseGetStatus.ERR');
            return $res;
        }
    }
}
