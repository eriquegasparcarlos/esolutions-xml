...
return array (
  ...
  array (
    ...
    'MontoBaseICBPERLinea' => 'sum(cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = \'7152\']]/cbc:TaxAmount)',
    ...
    'MontoBaseIGVLinea' => 'sum(cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = \'1000\']]/cbc:TaxableAmount)',
    'MontoBaseIVAPLinea' => 'sum(cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = \'1016\']]/cbc:TaxableAmount)',
