...
return array (
  ...
  array (
    ...
    'sacSUNATPerceptionSystemCode' => 'sac:SUNATPerceptionSystemCode',
    'sacSUNATPerceptionPercent' => 'sac:SUNATPerceptionPercent',
    'cbcNote' => 'cbc:Note',
    'cbcTotalInvoiceAmount' => 'cbc:TotalInvoiceAmount',
    'cbcTotalInvoiceAmountCurrencyID' => 'cbc:TotalInvoiceAmount/@currencyID',
    'sacSUNATTotalCashed' => 'sac:SUNATTotalCashed',
    'sacSUNATTotalCashedCurrencyID' => 'sac:SUNATTotalCashed/@currencyID',
    'fileName' => '$nombreArchivoEnviado',
    'rucFilename' => 'substring($fileName,1,11)',
    'numeroComprobante' => 'substring(cbc:ID, 6)',
