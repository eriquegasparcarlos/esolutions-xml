...
return array (
  ...
  array (
    ...
    'TasaPercent' => NULL,
    'totalPrecioVentaCalculadoIGV' => '$totalValorVenta + $SumatoriaISC + $SumatoriaICBPER + $SumatoriaOtrosTributos + $AnticiposISC + ($MontoBaseIGVLinea - $MontoDescuentoAfectoBI + $MontoCargosAfectoBI) * $TasaPercent',
    'sumatoriaIGVCalculado18' => NULL,
    'sumatoriaIGVCalculado10' => NULL,
    'sumatoriaFinal' => NULL,
